    ...
    <div class="row">
        <div class="col-8">
            ...
            <select onchange=" get(this.value)" class="form-select" name="selectedFilter">
                ...
                <option value="3">Comorbilidad</option>
                <option value="4">Edad</option>
                <option value="5">Fecha de vacunación</option>
...
<script>
    ...
    function get(value){
        switch (value) {
            ...
            case '2':
                ...
                $.ajax({
                url:"{{ route('vaccinated.byDoseAdmin') }}",
                method: "GET",
                data: {dose:FIRSTDOSE},
                success: 
                    function(data){
            ...
            case '4':
                ...
                $.ajax({
                url:"{{ route('vaccinated.withComorbidityAdmin') }}",
                method: "GET",
                data: {},
                success: 
                    function(data){
    ...
    function getByAge(value){
        ...
        $.ajax({
        url:"{{ route('vaccinated.byAgeAdmin') }}",
        method: "GET",
        data: {age: value},
        success: 
            function(data){
    ...
    function getByDate(value){
        ...
        console.log(value);
        $.ajax({
        url:"{{ route('vaccinated.byDateAdmin') }}",
        method: "GET",
